        ...
        <Box>
            ...
            <Box>
                ...
                <Box p='12px 0' display='flex' justifyContent='space-between'>
                    <Box>
                        <Heading fontWeight='500' color='#58a6ff' fontSize='1.25rem'> Includer </Heading>
                        <Text color='color.gray' fontSize='0.875rem' m='0 0 8px'>  WEB Developer</Text>
                        <Box display='flex' alignItems='center'>
                            <Box bg='green' w='12px' h='12px' borderRadius='full' m='4px'></Box>
                            <Text color='color.gray' fontSize='0.75rem'>Apr 2022 - Now</Text>
                        </Box>
                    </Box>
