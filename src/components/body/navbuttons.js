...
const Navbuttons = () => {
    ...
    return (
        <Box w='100%' m='20px auto 0 auto' display='flex' borderBottom='1px solid rgba(255, 255, 255, 0.1)'>
            ...
            <Box p='0 16px' w='70%' display='flex'>
                <Box _hover={{ cursor: 'pointer' }} onClick={() => setScreen(<Default />)} variant='link' _focus={{ boxShadow: 'none' }}>
                    <Box display='flex' p='8px 16px' h='48px' borderBottom='2px solid transparent' _hover={{ borderColor: 'gray.700' }}>
                        ...
                        <Text fontWeight='400' fontSize='0.9rem' color='color.light2'>Overview</Text>
                    </Box>
                </Box>
                <Box _hover={{ cursor: 'pointer' }} onClick={() => setScreen(<Packages />)} variant='link' _focus={{ boxShadow: 'none' }}>
                    <Box display='flex' p='8px 16px' h='48px' borderBottom='2px solid transparent' _hover={{ borderColor: 'gray.700' }}>
                        ...
                        <Text fontWeight='400' fontSize='0.9rem' color='color.light2'>Technologies</Text>
                    </Box>
                </Box>
                <Box _hover={{ cursor: 'pointer' }} onClick={() => setScreen(<Repositories />)} variant='link' _focus={{ boxShadow: 'none' }}>
                    <Box onClick='' display='flex' p='8px 16px' h='48px' borderBottom='2px solid transparent' _hover={{ borderColor: 'gray.700' }}>
                        ...
                        <Text fontWeight='400' fontSize='0.9rem' color='color.light2'>Experience</Text>
                    </Box>
                </Box >
