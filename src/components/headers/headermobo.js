...
import Navbuttonsmobo from "../body/navbuttonsmobo"
...
const Headermobo = () => {
    ...
    return (
        <Box p='0 16px' m='0 auto'>
            ...
            <Box p='0 8px'>
                <Box display='flex' alignItems='center' w='100%' p='4px 8px' border='1px solid rgba(255, 255, 255, 0.2)' borderRadius='5px'>
                    <Box w='30px'>
