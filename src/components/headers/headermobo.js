        ...
        <Box p='0 16px'>
            ...
            <Box display='flex' alignItems='center' >
                <Box display='flex'>
                    ...
                    <Text m='0 3px 0 0' fontWeight='500' color='rgba(255, 255, 255, 0.8)'>0</Text>
                    <Text fontWeight='300' color='rgba(255, 255, 255, 0.4)'>followers</Text>
                </Box>
                <Text m='0 4px' fontSize='12px' color='white'>•</Text>
                <Box display='flex'>
                    <Text  m='0 3px 0 0' fontWeight='500' color='rgba(255, 255, 255, 0.8)'>1</Text>
                    <Text fontWeight='300' color='rgba(255, 255, 255, 0.4)'>following</Text>
                </Box>
            </Box>
        </Box >
    )
