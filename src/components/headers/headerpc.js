        ...
        <>
            <Box colSpan={isLargerThan768 ? '1' : '4'}>
                ...
                <Box position='relative' top='270px'>
                    ...
                    <Box m='7px 0 20px 0' >
                        <Box m='0 0 15px 0'  display='flex' _hover={{borderColor: 'rgb(239, 239, 239)', bg: 'rgb(59, 59, 59)', cursor: 'pointer'}} justifyContent='center' alignItems='center' bg='#1f242b' p='5px 16px' border='1px solid rgba(255, 255, 255, 0.2)' borderRadius='5px'>
